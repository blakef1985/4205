SO THIS APP WAS SUPPOSED TO CREAT A SMALL WEB INTERFACE TO DISPLAY STORE  AND UPLOAD RETRIVE OR CHANGE DATA FROM A DB THE SQL COMMANDS DID NOT WORK SO IT RUNS A WEB APP WITH SOME PLACE HOLDER FILES.
